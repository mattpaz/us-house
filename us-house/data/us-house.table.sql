...
CREATE TABLE `us-house` (
  ...
  `title` enum('representative','house-speaker','house-majority-leader','house-majority-whip','house-minority-leader','house-minority-whip','republican-conference-chairman','republican-policy-committee-chairman','assistant-democratic-leader','democratic-caucus-chairman') NOT NULL DEFAULT 'representative',
